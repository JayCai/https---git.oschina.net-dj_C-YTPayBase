...
include 'head.php';
$id=$_GET[id];
$row=query("select * from tb_newstc where id='$id'");
?>
<div class="ureg">
...
mysql_query("update tb_newstc set leixing='$leixing',taocanzy='$taocanzy',zhouqi='$zhouqi',price='$price',scprice='$scprice',beizhu='$beizhu' where id='$id'");

   exit("<script>alert('修改成功!');window.location.href='list_newstc.php';</script>");
