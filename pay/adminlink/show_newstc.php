		 ...
		 <div class="uregbox">
			...
			<div class="admin_right">
			   ...
			   <?php 
				  ...
				  $id=$_GET['id'];
				  $v=query("select * from order_newstc where id='$id'");
			   ?>			
				  ...
				  <tr>
					 ...
					 <td style="padding:0px; border-bottom:0px;">	
						...
						<?php 
						   ...
						   foreach ($bh as $e){
							  if($e){	
								 $x=query("select * from tb_newstc where id='$e'");
							  ?>
							  <table width="500" border="0" cellspacing="0" cellpadding="0">
								 <tr>
									<td width="105"><?=$x['leixing']?></td>			
									<td width="105"><?=$x['price']?></td>
									<td width="105"><a href="up_newstc.php?id=<?=$e?>" target="_blank">查看详细</a></td>
								 </tr>
							  </table>
