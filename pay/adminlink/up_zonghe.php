...
mysql_query("update tb_zonghe set leixing='$leixing',taocanzy='$taocanzy',zhouqi='$zhouqi',price='$price',scprice='$scprice',beizhu='$beizhu' where id='$id'");

   exit("<script>alert('修改成功!');window.location.href='list_zonghe.php';</script>");
