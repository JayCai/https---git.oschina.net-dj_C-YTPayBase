  ...
  <!--right-->
	...
	<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
		<table width="911" height="586" border="0" cellpadding="0" cellspacing="0" class="addtable">
		  <tr>
			<td width="208" height="40">添加新闻套餐资源产品</td>
			<td width="600"></td>
			<td width="103"></td>
		  </tr>
		  <tr>
			<td width="208" height="50">类型</td>
			<td width="600">
...
mysql_query("insert into tb_newstc (leixing,taocanzy,zhouqi,price,scprice,beizhu,time) values ('$leixing','$taocanzy','$zhouqi','$price','$scprice','$beizhu','$time')");
