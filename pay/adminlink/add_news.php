	...
	<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
		<table width="911" height="305" border="0" cellpadding="0" cellspacing="0" class="addtable">
		  ...
		  <tr>
		    ...
		    <tr>
			<td>媒体名称</td>
			<td><input name="mtname" type="text" /></td>
			<td></td>
		  </tr>
		   <tr>
			<td width="150">入口</td>
		  ...
		  <tr>
			<td>会员价</td>
			<td><input name="price" type="text" style="width:60px;" /> 元</td>
			<td></td>
		  </tr>
		  <tr>
			<td>可否带链接</td>
			<td><input name="kedai" type="text"  size="40" /></td>
			<td></td>
		  </tr>
		  <tr>
			<td>是否收录</td>
			<td><input name="shoulu" type="text"  size="40" /></td>
			<td></td>
		  </tr>
		  <tr>
			<td>备注</td>
...
mysql_query("insert into tb_news (meiti,mtname,rukou,fenlei,area,link,price,kedai,shoulu,beizhu,time) values ('$meiti','$mtname','$rukou','$fenlei','$area','$link','$price','$kedai','$shoulu','$beizhu','$time')");
