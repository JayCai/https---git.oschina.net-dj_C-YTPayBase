...
mysql_query("update tb_bbs set bbstaocan='$bbstaocan',bbsleixing='$bbsleixing',fabutiao='$fabutiao',zhouqi='$zhouqi',price='$price',shoulu='$shoulu',beizhu='$beizhu' where id='$id'");

   exit("<script>alert('修改成功!');window.location.href='list_bbs.php';</script>");
