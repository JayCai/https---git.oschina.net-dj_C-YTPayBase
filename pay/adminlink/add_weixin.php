	...
	<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
		<table width="911" height="305" border="0" cellpadding="0" cellspacing="0" class="addtable">
		  ...
		  <tr>
			<td>微信名称</td>
			<td>
				<input name="weixinname" type="text" />
			</td>
			<td></td>
		  </tr>
		  <tr>
			<td>微信号</td>
			<td><input name="weixinhao" type="text"  /></td>
			<td></td>
		  </tr>
		  <tr>
			<td>粉丝数</td>
			<td><input name="fensi" type="text"  /> </td>
			<td></td>
		  </tr>
		  <tr>
			<td>单图文报价</td>
			<td><input name="dantuwen" type="text"   /> 元</td>
			<td></td>
		  </tr>
		  <tr>
			<td>多图文报价</td>
			<td><input name="duotuwen" type="text"   /> 元</td>
			<td></td>
		  </tr>
		  <tr>
			<td>备注</td>
...
mysql_query("insert into tb_weixin (fenlei,area,weixinname,weixinhao,fensi,dantuwen,duotuwen,beizhu,time) values ('$fenlei','$area','$weixinname','$weixinhao','$fensi','$dantuwen','$duotuwen','$beizhu','$time')");
