...
mysql_query("update tb_weibo set weibo='$weibo',fenlei='$fenlei',weiboname='$weiboname',area='$area',link='$link',fensi='$fensi',zhifa='$zhifa',zhuanfa='$zhuanfa' where id='$id'");

   exit("<script>alert('修改成功!');window.location.href='list_weibo.php';</script>");
