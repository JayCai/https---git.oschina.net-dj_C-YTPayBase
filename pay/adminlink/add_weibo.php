	...
	<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
		<table width="911" height="305" border="0" cellpadding="0" cellspacing="0" class="addtable">
		  ...
		  <tr>
		   ...
		   <tr>
			<td>微博名称</td>
			<td><input name="weiboname" type="text" /> </td>
			<td></td>
		  </tr>
		  <tr>
			<td>链接</td>
		  ...
		  <tr>
			<td>直发报价</td>
			<td><input name="zhifa" type="text"   /> 元</td>
			<td></td>
		  </tr>
		  <tr>
			<td>转发报价</td>
			<td><input name="zhuanfa" type="text"  /> 元</td>
			<td></td>
		  </tr>
		  <tr>
			<td></td>
...
mysql_query("insert into tb_weibo (weibo,fenlei,weiboname,area,link,fensi,zhifa,zhuanfa,time) values ('$weibo','$fenlei','$weiboname','$area','$link','$fensi','$zhifa','$zhuanfa','$time')");
