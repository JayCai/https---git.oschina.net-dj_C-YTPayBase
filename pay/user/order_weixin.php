  ...
  <div class="uregbox">
	...
	<table width="1182" border="0" cellspacing="0" cellpadding="0" class="order2">
	  <tr style="background-color: #006666; color:white;">
		...
		<td width="138">用户名</td>
		<td width="122">订单号</td>
		<td width="115">单图文价格</td>
		<td width="115">多图文价格</td>			
		<td width="67">订单状态</td>
		<td width="67">订单类型</td>
	  ...
	  <tr>
		...
		<td width="115"><?=$v['dantuwen']?></td>
		<td width="115"><?=$v['duotuwen']?></td>		
		<td width="67"><?=$v['type']?></td>
		<td width="67"><?=$v['leixing']?></td>
		<td width="109"><?=$v['time']?></td>
		<td width="109"><a href="show_weixin.php?id=<?=$v[id]?>&caozuoid=weixin&leixing=<?=$v['leixing']?>">查看详情</a></td>
	  </tr>	
	  <?php
	  }
	  ?> 
