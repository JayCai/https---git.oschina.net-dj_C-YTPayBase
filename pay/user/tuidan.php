			  ...
			  <div class="uright">
				<table width="953" height="38" border="0" cellpadding="0" cellspacing="0" class="order3">
				 ...
				 <?php		
				   ...
				   $numq=mysql_query("select * from tuidan where user='$user'");
				   require_once 'page.php';
				   $list=listquery("select * from tuidan where user='$user' order by id desc  limit ".$num.",20");			
				  foreach($list as $v){
				  $xrmb+=$v['price'];
				  ?>
				   <tr>					
			...
			<table width="953" height="38" border="0" cellpadding="0" cellspacing="0" class="order3">
				  ...
				  <select onchange="window.location='?page='+this.value">
				   ...
				   页
			 	   ...
			 	   <a href="" style="float:right; border:0px; margin-right:20px;">退单金额总计:<?=$xrmb?>元</a>
				   </td>
			    </tr>
			  </table>
	          </div>
